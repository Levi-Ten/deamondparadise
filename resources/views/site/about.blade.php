...
<div class="lazy_animation">
    <div class="lazy">
        <img class="dryer" src="{{asset('public/public/img/dryer.png')}}" alt=""> 
        <img class="combScissors" src="{{asset('public/public/img/comb.png')}}" alt="">
        <img class="combScissors" src="{{asset('public/public/img/scissors.png')}}" alt="">
        <img class="straightener" src="{{asset('public/public/img/straightener.png')}}" alt="">
    </div>
