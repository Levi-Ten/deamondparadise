...
<div class="lazy_animation">
    <div class="lazy">
        <img class="dryer" src="{{asset('img/dryer.png')}}" alt=""> 
        <img class="combScissors" src="{{asset('img/comb.png')}}" alt="">
        <img class="combScissors" src="{{asset('img/scissors.png')}}" alt="">
        <img class="straightener" src="{{asset('img/straightener.png')}}" alt="">
    </div>
